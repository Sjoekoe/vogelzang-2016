    ...
    export default {
        ...
        ready: function() {
            $.getJSON('/api/reservations', function (reservations) {
                var group = _.groupBy(reservations.data, function(reservation) {
                    return reservation.week_day;
                });
                ...
                for (var i = 0; i <= 6; i++) {
                    ...
                    var dayText = newDay.format('dddd');

                    html += '<li class="events-group">';
                    html += '<div class="top-info"><span>' + dayText + '</span></div>';
                    html += '<ul>';
